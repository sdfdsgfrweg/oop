...
{
	Rectangle r( Point( 0.0, 1.0 ), Point( 3.0, 5.0 ) );
	assert( r.getTopLeft() == Point( 0.0, 1.0 ) );
	assert( r.getBottomRight() == Point( 3.0, 5.0 ) );
}
...
{
	Rectangle r( Point( 0.0, 1.0 ), 2.0, 4.0 );
	assert( r.getTopLeft() == Point( 0.0, 1.0 ) );
	assert( r.getBottomRight() == Point( 2.0, 5.0 ) );
}
...
DECLARE_OOP_TEST( rectangle_test_ConstructorTopLeftRightBottom_wrong )
{
	...
	{
		assert( ! strcmp( e.what(), "Invalid rectangle coordinates" ) );
	}

	try
	{
		Rectangle r( Point( 0.0, 6.0 ), Point( 2.0, 5.0 ) );
		assert( ! "Exception expected" );
	}
	catch ( std::exception & e )
	{
...
{
	Rectangle r1( Point( 0.0, 1.0 ), Point( 3.0, 5.0 ) );
	assert( r1.getTopLeft() == Point( 0.0, 1.0 ) );
	assert( r1.getTopRight() == Point( 3.0, 1.0 ) );
	assert( r1.getBottomLeft() == Point( 0.0, 5.0 ) );
	assert( r1.getBottomRight() == Point( 3.0, 5.0 ) );

	Rectangle r2( Point( 0.0, 3.0 ), 2.0, 5.0 );
	assert( r2.getTopLeft() == Point( 0.0, 3.0 ) );
	assert( r2.getTopRight() == Point( 2.0, 3.0 ) );
	assert( r2.getBottomLeft() == Point( 0.0, 8.0 ) );
	assert( r2.getBottomRight() == Point( 2.0, 8.0 ) );
}
...
{
	Rectangle r1( Point( 0.0, 1.0 ), Point( 3.0, 5.0 ) );
	Rectangle r2( Point( 0.0, 1.0 ), Point( 3.0, 5.0 ) );
	Rectangle r3( Point( 0.0, 1.0 ), Point( 2.0, 5.0 ) );
	Rectangle r4( Point( 0.1, 1.0 ), Point( 2.0, 2.0 ) );
...
{
	Rectangle r1( Point( 0.0, 1.0 ), Point( 3.0, 5.0 ) );
	Rectangle r2( Point( 1.0, 0.0 ), Point( 5.0, 3.0 ) );
	Rectangle r3( Point( 0.0, -2.0 ), Point( 5.0, 0.0 ) );
	Rectangle r4( Point( 4.0, 2.0 ), Point( 5.0, 3.0 ) );
...
{
	Rectangle r1( Point( 0.0, 1.0 ), Point( 3.0, 5.0 ) );
	Rectangle r2( Point( 1.0, 2.0 ), Point( 2.0, 4.0 ) );
	Rectangle r3( Point( 1.0, 2.0 ), Point( 3.5, 4.0 ) );
	Rectangle r4( Point( 1.0, 0.0 ), Point( 2.0, 4.0 ) );
